...
export const projects = [
  {
    id: 1,
    title: "Marrakech Events Hub - WordPress Website",
    subtitle:
      "A comprehensive WordPress platform for events, festivals, and cultural activities in Marrakech",
    status: "in progress",
    label: "feature",
    priority: "low",
    description:
      "Developing a responsive WordPress website with event management system, ticket booking, venue listings, and local business directory for Marrakech's vibrant event scene. The site includes multilingual support (Arabic, French, English), payment integration, and mobile-responsive design.",
    percentage: 65,
    assign: [
    ...
    assignDate: "24 June 2026",
    dueDate: "02 March 2026",
    isFavorite: true,
  },

  {
    ...
    subtitle: "Internal project management system for multi-department teams",
    status: "in progress",
    label: "enhancement",
    priority: "high",
    description:
      "Building a full-stack MERN application to manage projects, tasks, departments, and user roles. Includes authentication, permissions, Kanban board, analytics dashboard, and real-time notifications.",
    percentage: 40,
    assign: [
      { image: avatar2, label: "Jane Smith", value: "jane.smith" },
      { image: avatar5, label: "Omar Khalid", value: "omar.khalid" },
    ],
    assignDate: "10 January 2026",
