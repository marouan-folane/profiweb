export const questionTranslations = {
    ...
    servicesOffered: {
        en: "List the main services or products your company provides to its customers.",
        fr: "Listez les principaux services ou produits que votre entreprise fournit à ses clients.",
        ar: "قائمة بالخدمات أو المنتجات الرئيسية التي تقدمها شركتك لعملائها.",
        de: "Listen Sie die wichtigsten Dienstleistungen oder Produkte auf, die Ihr Unternehmen seinen Kunden anbietet."
    },
    businessAddress: {
