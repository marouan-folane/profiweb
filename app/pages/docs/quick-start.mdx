...
The DashTail-vX.X.X.zip Package encompasses all the files showcased in the live [demo](http://dastail.MayaGroup.net/), including all layouts, apps, pages, components, and elements. You can copy the necessary things from there and then use them on your project.
