            ...
            <div className="bg-default-100 rounded-xl py-8 px-6 flex flex-col">
              <div className="flex-none">
                ...
                <p className="text-sm xl:text-base  text-default-600">
                  ...
                  arrangement, please
                  <Link href="https://MayaGroup.net/" className="text-primary mx-1 hover:underline">
                    Get In Touch
                  </Link>
              ...
              <Button asChild>
                  <Link href="https://MayaGroup.net/contact-us" target="__blank" className="mt-8 xl:mt-12 w-full">
                    Contact us
                  </Link>
              </Button>
            </div>
