...
const Footer = () => {
  const socials = [
    {
      icon: facebook,
      href: "https://www.facebook.com/MayaGroupbd/"
    },
    {
      icon: github,
      href: "https://github.com/MayaGroup-bd"
    },
    {
      icon: linkedin,
      href: "https://www.linkedin.com/company/MayaGroup/"
    },
    {
      icon: youtube,
      href: "https://www.youtube.com/@MayaGroup4181"
    },
    {
      icon: twitter,
      href: "https://twitter.com/MayaGroupbd"
    },
    {
      icon: dribble,
      href: "https://dribbble.com/MayaGroupbd"
    },
    {
      icon: behance,
      href: "https://www.behance.net/MayaGroup"
    }
  ]
  return (
    <footer
    ...
    >
      ...
      <div className="relative bg-default-900 dark:bg-default-50 py-6">
        <div className="container flex flex-col text-center md:text-start md:flex-row gap-2">
          <p className="text-primary-foreground flex-1 text-base xl:text-lg font-medium">COPYRIGHT &copy; 2026 All rights Reserved</p>
          <p className="text-primary-foreground flex-none text-base font-medium">
            Hand-crafted & Made by {" "}
            <Link href="#" target="__blank" className="text-primary hover:underline">Maya group</Link></p>
        </div>
      </div>
    </footer>
  );
