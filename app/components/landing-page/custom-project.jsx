    ...
    >
      ...
      <div className="max-w-[670px] mx-auto">
        ...
        <p className="text-sm xl:text-base leading-7 text-center text-default-700 ">
          ...
          Count on MayaGroup to provide a tailored transformation that fits your business goals perfectly.
        </p>

        <div className="flex justify-center gap-8 mb-10 xl:mb-[72px] mt-7 xl:mt-9">
          <Button variant="outline" asChild>
            <Link href="https://themeforest.net/user/MayaGroupbd" target="_blank"> Take a Tour</Link>
          </Button>
          <Button asChild>
            <Link href="https://MayaGroup.net/contact-us">Contact Us</Link>
          </Button>
        </div>
      </div>
