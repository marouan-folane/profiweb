            ...
            <Accordion type="single" collapsible className="space-y-6" >
              ...
              >
                ...
                <AccordionContent className="text-sm xl:text-base text-default-700">
                  ...
                  If you need GitHub access then you can ask our     <Link href="https://MayaGroupbd.freshdesk.com/support/login" target="_blank" className="text-primary">support team</Link>. for GitHub access.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem
                value="item-5"
          ...
          <div>
            <Accordion type="single" collapsible className="space-y-6" >
              ...
              >
                ...
                <AccordionContent className="text-sm xl:text-base text-default-700">
                  For assistance, head over to our <Link href="https://MayaGroupbd.freshdesk.com/support/login" target="_blank" className="text-primary">support portal</Link> , register, and submit a ticket.
