  ...
  return (
    <>
      ...
      <Card
        ...
        {...attributes}
        className={cn(
          "shadow  border-border  p-3 cursor-pointer group relative",
          {
      ...
      >
        <CardHeader className="space-x-0 space-y-0 p-0 flex-row items-center justify-between mb-0 border-none">
          <div className="flex items-center gap-1">
            <div className="text-[10px] leading-[14px] font-semibold uppercase text-default-600 border border-border px-1.5  rounded-sm">
              {getWords(title)}
            </div>
            ...
            <div onClick={(e) => e.stopPropagation()}>
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <div className="text-[10px] leading-[14px] font-semibold  text-default-600 border border-border px-1.5  rounded-sm flex justify-center items-center gap-[2px]">
